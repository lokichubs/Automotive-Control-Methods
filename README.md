...
### Results
Trajectory following and control performance are shown below: (find all attempts [here](assets/PID))

![PID Results](assets/img/Attempt_9.png)

Simulation video is shown below:
https://github.com/lokichubs/Automotive-Control-Methods/blob/main/assets/vid/pid_sim_vid.mp4